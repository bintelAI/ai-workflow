           ...
           <div>
              ...
              <div className="pt-4 mt-4 border-t border-slate-100">
                   <div className="flex items-center justify-between mb-3">
                      ...
                      >
                          <div className={`w-4 h-4 rounded-full bg-white shadow-sm transition-transform ${config?.devMode !== false ? 'translate-x-4' : 'translate-x-0'}`} />
                      </div>
                  </div>
                  {config?.devMode !== false && (
                      <textarea
                          ...
                          value={config?.devInput || '{"order_id": "ORD-2024-001", "amount": 8500, "currency": "CNY", "requester": {"id": "U-8821", "name": "Alex Chen", "department": "Engineering"}, "items": [{"name": "Server License", "price": 4000}, {"name": "Cloud Credits", "price": 4500}]}'}
