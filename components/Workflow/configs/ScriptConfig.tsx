...
export const ScriptConfig: React.FC<ScriptConfigProps> = ({ config, onConfigChange, loadingField, onAIGenerate }) => {
    return (
        <div className="space-y-5">
             <div className="flex gap-4">
                <div className="flex-1">
                    <label className="block text-xs font-medium text-slate-500 mb-1 uppercase">运行环境</label>
                    <select
                ...
                <div className="flex-1">
                    <label className="block text-xs font-medium text-slate-500 mb-1 uppercase">输出字段名</label>
                    <input
                       type="text"
