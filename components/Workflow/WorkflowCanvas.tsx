...
const nodeTypes: NodeTypes = {
  ...
  [WorkflowNodeType.APPROVAL_AI_REVIEW]: ApprovalAIReviewNode,
  ...
  [WorkflowNodeType.MUL_QUERY]: DataOpNode,
  [WorkflowNodeType.MUL_UPDATE_ROW]: DataOpNode,
  [WorkflowNodeType.MUL_DELETE_ROW]: DataOpNode,
